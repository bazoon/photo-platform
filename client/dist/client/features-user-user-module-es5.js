...
var ContestApplicationComponent = /** @class */ (function () {
    ...
    ContestApplicationComponent.prototype.getCurrentSection = function () {
        var _this = this;
        return this.sections.find(function (s) { return s.id === _this.currentSection; });
    };
    ContestApplicationComponent.prototype.upload = function () {
        ...
        var maxWeight = section && section.maxWeight;
        var hasOversize = this.fileList.some(function (f) { return f.size > maxWeight * 1024; });
        if (hasOversize) {
    ...
    ContestApplicationComponent.prototype.updateUploadPossibility = function () {
        var section = this.getCurrentSection();
        var maxCountImg = section && section.maxCountImg;
