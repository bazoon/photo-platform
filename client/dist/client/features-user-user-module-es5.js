...
var ContestApplicationComponent = /** @class */ (function () {
    function ContestApplicationComponent(api, route) {
        var _this = this;
        this.api = api;
        this.route = route;
        this.sections = [];
    ...
    ContestApplicationComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (p) {
            _this.api.get("api/contestSections/all/" + p.get('id')).subscribe(function (sections) {
    ...
    ContestApplicationComponent.prototype.upload = function () {
        ...
        this.api.post("api/contestSections/" + this.currentSection + "/uploads", formData).subscribe(function () {
            _this.fileList = [];
            _this.loadImages();
        });
    };
    ...
    ContestApplicationComponent.prototype.loadImages = function () {
        var _this = this;
        this.api.get("api/contestSections/" + this.currentSection + "/files").subscribe(function (files) {
            _this.files = files;
        });
    };
...
var ShortListComponent = /** @class */ (function () {
    function ShortListComponent(api) {
        this.api = api;
        this.contests = [];
        this.currentContestId = -1;
        this.currentSection = 1;
