...
module.exports = "nz-header {\n  display: flex;\n  justify-content: space-between;\n  max-width: 100hv;\n}\n.logo-menu-container {\n  display: flex;\n  align-items: center;\n}\n.user-login {\n  cursor: pointer;\n  font-weight: 900;\n}\nnz-content {\n  min-height: calc(100vh - 64px - 90px);\n}\nnz-footer {\n  background-color: #001529;\n  color: #fff;\n}\n.footer-wrap {\n  display: flex;\n  justify-content: space-between;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let GoogleComponentIcon = class GoogleComponentIcon {
};
...
let ApiService = class ApiService {
    constructor(http, router, cookie, currentUser) {
        this.http = http;
        this.router = router;
        this.cookie = cookie;
        this.currentUser = currentUser;
    ...
    postEmpty(url) {
        const result = this.http.post(url, '', httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["share"])());
        result.subscribe(() => { }, e => this.errorHandler(e));
        return result;
    }
    get(url) {
        const result = this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["share"])());
        result.subscribe(() => { }, e => this.errorHandler(e));
        return result;
    }
    put(url, data) {
...
let AboutComponent = class AboutComponent {
    ...
    ngOnInit() {
        this.api.get('/api/about').subscribe(a => {
            this.about = a;
        });
    }
};
...
module.exports = ".sections {\n  display: flex;\n  flex-wrap: wrap;\n  margin-top: 10px;\n}\n.section-wrap {\n  position: relative;\n  background-color: #fff;\n  width: 200px;\n  height: 200px;\n  margin-right: 10px;\n  cursor: pointer;\n}\n.section-wrap:last-child {\n  margin-right: 0;\n}\n.section-wrap img {\n  width: 200px;\n  height: 200px;\n  -o-object-fit: conver;\n     object-fit: conver;\n  -webkit-filter: brightness(0.7);\n          filter: brightness(0.7);\n}\n.section-name {\n  top: 0;\n  position: absolute;\n  width: 100%;\n  min-height: 100px;\n  color: #fff;\n  font-size: 20px;\n  font-weight: bold;\n  padding: 40px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".login-form-container {\n  margin-top: 80px;\n  display: flex;\n  justify-content: center;\n}\n.login-form {\n  max-width: 300px;\n}\n.login-form-forgot {\n  float: right;\n}\n.login-form-button {\n  width: 100%;\n}\n.login-error {\n  color: #883434;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
const googleId = '1051258655371-avvqdidjqst2lr3j9fl5b5mtib5v8e9i.apps.googleusercontent.com';
const fbLink = `https://www.facebook.com/v4.0/dialog/oauth?scope=email&client_id=3530004347107670&redirect_uri=${location.origin}/oauth/fb&state=somestate&response_type=token`;
...
module.exports = ".main {\n  margin-bottom: 40px;\n  max-width: 1200px;\n  margin: 0 auto;\n}\n.image-container {\n  display: flex;\n  justify-content: center;\n  position: relative;\n  height: 500px;\n}\n.icon-left {\n  position: absolute;\n  left: 20px;\n  top: 50%;\n  transform: translateY(-50%);\n  font-size: 50px;\n  color: silver;\n  cursor: pointer;\n}\n.icon-right {\n  position: absolute;\n  right: 20px;\n  top: 50%;\n  transform: translateY(-50%);\n  font-size: 50px;\n  color: silver;\n  cursor: pointer;\n}\n.competition-header {\n  font-size: 30px;\n  font-weight: 900;\n  text-align: center;\n}\n.img {\n  -o-object-fit: contain;\n     object-fit: contain;\n  max-width: 800px;\n  height: 500px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".img {\n  width: 100%;\n  -o-object-fit: contain;\n     object-fit: contain;\n  max-height: 100%;\n  max-height: calc(100vh - 80px);\n}\n.modal {\n  padding: 20px;\n  height: calc(100vh - 40px);\n  background-color: #ffffff;\n}\n.mask {\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: 1000;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.65);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".publications {\n  list-style-type: none;\n}\n.publications li {\n  margin-bottom: 10px;\n}\n.publication-name {\n  font-weight: 600;\n  margin-bottom: 10px;\n  font-size: 16px;\n}\n.publication-digest {\n  font-weight: 200;\n  font-size: 12px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".publications {\n  list-style-type: none;\n  padding: 0;\n}\n.publications li {\n  margin-bottom: 10px;\n}\n.publication-name {\n  font-size: 16px;\n  font-weight: 900;\n}\n.publication-digest {\n  font-weight: 300;\n  font-size: 12px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".register-container {\n  margin-top: 80px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let RulesComponent = class RulesComponent {
    ...
    load(lang) {
        this.api.get(`api/rules/${lang}`).subscribe(r => {
            this.rules = r;
        });
    }
};
...
module.exports = ".thumb {\n  width: 150px;\n  height: 150px;\n  -o-object-fit: cover;\n     object-fit: cover;\n}\n.thumb:last-child {\n  margin-right: 0px;\n}\n.thumb-wrap {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  margin-right: 10px;\n  margin-bottom: 10px;\n  overflow: hidden;\n  max-width: 150px;\n}\n.thumb-wrap i {\n  cursor: pointer;\n}\n.thumb-wrap:hover .rate {\n  display: block;\n}\n.thumb:hover {\n  -webkit-filter: brightness(0.4);\n          filter: brightness(0.4);\n}\n.photos {\n  display: flex;\n  flex-wrap: wrap;\n}\n.rate {\n  font-size: 14px;\n  display: none;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  color: white;\n  font-weight: bold;\n  transform: translate(-50%, -50%);\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let ThesisComponent = class ThesisComponent {
    constructor(api, translate) {
        this.api = api;
        this.translate = translate;
    }
    ...
    load(lang) {
        this.api.get(`api/thesis/${lang}`).subscribe(t => {
            this.thesis = t;
        });
    }
};
ThesisComponent.ctorParameters = () => [
...
let CurrentUserService = class CurrentUserService {
    ...
    login(loginData) {
        this.http.post('api/login', loginData).subscribe(u => {
            this.user = u;
    ...
    loginFb(payload) {
        this.http.post(`api/login-fb`, payload).subscribe(user => {
            this.user = user;
            this.isLoggedIn = true;
            this.save();
            this.updateRoles();
    ...
    loginVk(payload) {
        this.http.post(`api/login-vk`, payload).subscribe(user => {
            this.user = user;
            this.isLoggedIn = true;
            this.save();
            this.updateRoles();
    ...
    loginGoogle(payload) {
        console.log(payload);
        this.http.post(`api/login-google`, payload).subscribe(user => {
            this.user = user;
            this.isLoggedIn = true;
            this.save();
            this.updateRoles();
    ...
    register(user) {
        ...
        this.http.post('api/register', formData).subscribe(u => {
            this.user = u;
            this.isLoggedIn = true;
            this.save();
            this.updateRoles();
    ...
    updateRoles() {
        this.http.get('api/roles').subscribe(role => {
...
module.exports = __webpack_require__(/*! /var/www/fotoregion.site/photo-platform/client/src/main.ts */"./src/main.ts");
