...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.loadMenu = function () {
        ...
        this.api.get("api/admin/contestMenus/all").subscribe(function (contestMenus) {
            _this.contestMenus = contestMenus;
        });
    };
...
var ContestPhotosComponent = /** @class */ (function () {
    function ContestPhotosComponent(api) {
        this.api = api;
        this.sections = [];
    }
    ContestPhotosComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.api.get('api/contestPhotos/sections').subscribe(function (sections) {
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.prev = function () {
    };
...
var PublicationComponent = /** @class */ (function () {
    ...
    PublicationComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (p) {
            _this.api.get("api/publications/single/" + p.get('id')).subscribe(function (pub) {
                _this.pub = pub;
            });
        });
    };
...
var PublicationsComponent = /** @class */ (function () {
    ...
    PublicationsComponent.prototype.load = function (lang, menuId) {
        var _this = this;
        this.api.get("api/publications/" + menuId + "/" + lang).subscribe(function (pubs) {
            _this.pubs = pubs;
        });
    };
...
var SectionPhotosComponent = /** @class */ (function () {
    ...
    SectionPhotosComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (p) {
            ...
            _this.api.get("api/contestPhotos/photos/" + id).subscribe(function (photos) {
                _this.photos = photos;
            });
            _this.api.get("api/contestSections/" + id).subscribe(function (section) {
...
var CurrentUserService = /** @class */ (function () {
    function CurrentUserService(api, router) {
        this.api = api;
        this.router = router;
    ...
    CurrentUserService.prototype.login = function (loginData) {
        var _this = this;
        this.api.post('api/login', loginData).subscribe(function (u) {
            _this.user = u;
    ...
    CurrentUserService.prototype.loginFb = function (payload) {
        var _this = this;
        this.api.post("api/login-fb", payload).subscribe(function (user) {
            _this.user = user;
            _this.isLoggedIn = true;
            _this.save();
            _this.updateRoles();
    ...
    CurrentUserService.prototype.loginVk = function (payload) {
        var _this = this;
        this.api.post("api/login-vk", payload).subscribe(function (user) {
            _this.user = user;
            _this.isLoggedIn = true;
            _this.save();
            _this.updateRoles();
    ...
    CurrentUserService.prototype.register = function (user) {
        ...
        this.api.post('api/register', formData).subscribe(function (u) {
            _this.user = u;
            _this.isLoggedIn = true;
            _this.save();
            _this.updateRoles();
    ...
    CurrentUserService.prototype.logout = function () {
        var _this = this;
        this.api.postEmpty('api/logout').subscribe(function () {
            _this.remove();
    ...
    CurrentUserService.prototype.updateRoles = function () {
        var _this = this;
        this.api.get('api/roles').subscribe(function (role) {
