...
export class PublicationsComponent implements OnInit {
  ...
  constructor(private api: ApiService, private route: ActivatedRoute, private translate: TranslateService) {
  ...
  load(lang: string, menuId: any) {
    this.api.get<Array<PublicPublication>>(`api/publications/${menuId}/${lang}`).subscribe(pubs => {
      this.pubs = pubs;
    });
  }
