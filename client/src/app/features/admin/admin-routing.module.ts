...
import {ContestSectionsComponent} from 'src/app/features/admin/contest-sections/contest-sections.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'contests/:id/sections',
        component: ContestSectionsComponent
      },
      {
