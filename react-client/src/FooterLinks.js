...
function FooterLinks(){
  ...
  return(
    <div className="grid gap-2 grid-cols-2 grid-rows-3">
      <Link className="text-gray2 no-underline hover:underline" to="thesis">{t("about")}</Link>
      <Link className="text-gray2 no-underline hover:underline" to="partners">{t("partners")}</Link>
      <Link className="text-gray2 no-underline hover:underline" to="organizers">{t("organizer")}</Link>
